...
#
# Emits lib/js.dart (dart:js_interop / Wasm). The Imaging.js surface is small and
# needs List/Transform/Future boundary wrappers that cannot be derived from
# native.dart's FFI bodies, so this file is the source of truth for web bindings.
# Run: codegen/codegen.sh (or: codegen/autojs.jq < lib/native.dart > lib/js.dart)
